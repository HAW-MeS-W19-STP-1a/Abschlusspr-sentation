...
\begin{frame}
  ...
  \begin{figure}
    ...
    \end{minipage}% <- sonst wird hier ein Leerzeichen eingefÃ¼gt
    \hfill
    \begin{minipage}[t]{0.45\linewidth}
      \centering
...
\begin{frame}
  ...
  \item Einstellen der Kommunikationschnittstelle über die Benutzeroberfläche
...
\begin{frame}
  \begin{itemize}
  \item Für die Verbindung des Mastes (Anemometer und Windfahne) mit der Wetterstation
  \item Befestigung an de Wetterstaion mittels Steckverbindung
...
\begin{frame}
  ...
  \begin{itemize}
  \item Für die Unterbringung des Mikrokontrollers, der Spannungsversorgung und des Motortreibers
...
%   \item \emph{Kommunikation Ã¼ber Bluetooth}
